---
layout: post
title:  " Machin Learning 7-(3) :: training-test dataset, learning rate, normalization "
date:   2018-02-18
...
{% capture images %}
/assets/img/machin_learning/ML_7_3_1.png
{% endcapture %}
...
{% capture images %}
/assets/img/machin_learning/ML_7_3_2.png
{% endcapture %}
{% include gallery images=images caption=" " cols=1 %}
...
{% capture images %}
/assets/img/machin_learning/ML_7_3_3.png
{% endcapture %}
{% include gallery images=images caption=" " cols=1 %}
