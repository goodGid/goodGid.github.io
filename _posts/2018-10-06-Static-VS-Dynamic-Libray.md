...
* 라이브러리 내에 있는 루틴들은 범용적으로 사용도 가능하며, 3차원 애니메이션 그래픽 등과 같이 특별한 용도의 함수로 설계 될 수도 있다. 
...
* 프로그램 시작할 때 같이 로딩되어 프로그램 종료 할 때 **메모리**에서 **해제**되는 방법을 **암시적 링킹(Implicit Linking)**이라 한다.
